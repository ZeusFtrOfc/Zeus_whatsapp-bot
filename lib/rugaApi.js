...
const facebook = async (url) => new Promise((resolve, reject) => {
	...
	.then((res) => {
		...
		resolve({VideoUrl: res.data.result.VideoUrl})
	})
	.catch((err) =>{
        reject(err)
    })
...
const wikien = async (query) => new Promise((resolve, reject) => {
    axios.get(`https://videfikri.com/api/wikieng/?query=${query}`)
    .then((res) =>{
                resolve(res.result)
    })
    .catch(err => {
...
const cinta = async () => new Promise((resolve, reject) => {
    ...
    .then((res) => {
        const text = `Zeus: ${res.data.result}\n\nBy : Zeus`
        resolve(text)
    })
    .catch((err) =>{
        reject(err)
...
const zeus = async () => new Promise((resolve, reject) => {
    ...
    .then((res) => {
        const text = `${res.data.result.quotes} -kata Zeus`
        resolve(text)
    })
    .catch((err) =>{
        reject(err)
...
const tulis = async (teks) => new Promise((resolve, reject) => {
    axios.get(`http://api.itsmeikyxsec404.xyz/nulis?apikey=itsmeiky633&q=${teks}`)
    .then((res) => {
