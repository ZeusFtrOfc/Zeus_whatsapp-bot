...
const ytmp4 = async (url) => new Promise((resolve, reject) => {
    axios.get(`https://tobz-api.herokuapp.com/api/ytv?url=${url}&apikey=BotWeA`)
    .then((res) => {
		resolve(res.data)
    })
    .catch((err) =>{
...
const stalkig = async (url) => new Promise((resolve, reject) => {
    axios.get(`http://nzcha-apii.herokuapp.com/igstalk?username=${url}`)
    .then((res) => {
...
const chord = async (url) => new Promise((resolve, reject) => {
    axios.get(`https://st4rz.herokuapp.com/api/chord?q=${url}`)
    .then((res) => {
		if (res.data.error) resolve(res.data.error)
        resolve(res.data.result)
    })
...
const artinama = async (nama) => new Promise((resolve, reject) => {
	axios.get(`http://nzcha-apii.herokuapp.com/artinama?nama=${nama}`)
	.then((res) => {
		resolve(res.data.result)
	})
	.catch((err) => {
...
const cekjodoh = async (nama,pasangan) => new Promise((resolve, reject) => {
	axios.get(`https://api.vhtear.com/primbonjodoh?nama=${nama}&pasangan=${pasangan}&apikey=${vhtearkey}`)
	.then((res) => {
...
const lirik = async (judul) => new Promise((resolve, reject) => {
    axios.get(`https://tobz-api.herokuapp.com/api/lirik?q=${judul}&apikey=BotWeA`)
    .then((res) => {
        resolve(res.data.result)
    })
    .catch((err) =>{
...
const movie = async (judul) => new Promise((resolve, reject) => {
	axios.get(`https://api.zeks.xyz/api/film?q=${judul}&apikey=apivinz`)
	.then((res) => {
		if (res.data.error) return resolve({status: 'error', hasil: res.data.result})
		const teksmov = `Judul: ${res.data.result.judul}\nRating: ${res.data.result.rating}\nSinopsis: ${res.data.result.genre_negara}\nLink: ${res.data.result.link}`
...
const stalktt = async (query) => new Promise ((resolve, reject) => {
    axios.get(`https://docs-jojo.herokuapp.com/api/stalk?username=${query}`)
    .then((res) => {
        if (res.data.error) resolve(res.data.error)
...
const stalktwit = async (url) => new Promise((resolve, reject) => {
    axios.get(`https://arugaz.my.id/api/media/stalktwitt?user=${url}`)
    .then((res) => {
        if (res.data.error) resolve(res.data.error)
...
const spamcall = async (notlp) => new Promise((resolve, reject) => {
	axios.get(`https://api.zeks.xyz/api/spamcall?no=${notlp}&apikey=apivinz`)
	.then((res) => {
