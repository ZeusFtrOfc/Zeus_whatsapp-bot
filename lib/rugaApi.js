...
const darkjokes = async () => new Promise((resolve, reject) => {
    axios.get(`https://api-zeks.xyz/api/darkjokes?apikey=benbenz`)
    .then((res) => {
        resolve(res.data.result)
    })
    .catch((err) =>{
...
const memeindo = async () => new Promise((resolve, reject) => {
    axios.get(`https://api.zeks.xyz/api/memeindo?apikey=benbenz`)
    .then((res) => {
        resolve(res.data.result)
    })
    .catch((err) =>{
...
const fb = (url) => new Promise((resolve, reject) => {
    ...
    axios.get(`https://arugaz.my.id/api/media/facebook?url=${url}`)
        .then((result) => resolve(result))
        .catch((err) => reject(err))
})
...
const stalkig = async (query) => new Promise((resolve, reject) => {
    axios.get(`https://tobz-api.herokuapp.com/api/stalk?username=${query}&apikey=BotWeA`)
    .then((res) => {
...
const ssweb = async (url) => new Promise((resolve, reject) => {
    axios.get(`https://tobz-api.herokuapp.com/api/screenshotweb?url=${url}&apikey=BotWeA`)
    .then(res => {
        resolve(res)
    })
    .catch(err => {
