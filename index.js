...
const start = async (urbae = new urbae()) => {
    ...
    console.log(color(figlet.textSync('ZeusXz Bot', { font: 'Ghost', horizontalLayout: 'default' })))
    console.log(color('------------------------------------------------------------------------', 'white'))
    console.log(color('[CREATOR]', 'aqua'), color('ZeusXz', 'magenta'))
    console.log(color('[BOT]', 'aqua'), color('ZX BOT is now Online!', 'magenta'))
